    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-6 row-content">
                ...
                <h1 class="fw-bold display-1-sm">Cari Working Space?<br><span class="first-color">Working Space</span> aja!</h1>
                <p class="fs-4">
                    Di sini, kamu dapat mencari Working Space dengan harga termurah!
                </p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Fadli's File SSD\WebDev\pweb-mid\resources\views/home.blade.php ENDPATH**/ ?>