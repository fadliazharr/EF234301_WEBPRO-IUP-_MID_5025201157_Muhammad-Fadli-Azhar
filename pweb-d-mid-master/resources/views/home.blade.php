    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-md-6 row-content">
                {{-- <p class="lead fs-4">Muhammad Fadli Azhar | 5025201157</p> --}}
                ...
                <a class="btn rounded-pill btn-rounded text-white" style="background-color:#345cb3;"href="@auth {{ route('catalog') }} @endauth @guest {{ route('login') }} @endguest">Lihat Working Space yang tersedia! ></a>
            </div>
            <div class="col-md-6">
